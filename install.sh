...
# Add base packages
apt install unzip picom bspwm openbox polybar lxpanel lightdm rofi kitty thunar flameshot neofetch sxhkd git lxpolkit lxappearance xorg firefox pulseaudio pavucontrol -y
